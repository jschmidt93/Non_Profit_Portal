...
<div class="add-user-box">
    <form action="modify_query_user.php?id=<?php echo $user_id; ?>" method="POST" style="margin: 0 auto;">
        ...
        <input id="name" class="input" type="text" maxlength="100" name="first_name" required value="<?php echo $user_fname; ?>" /><br><br>
        
    <label for="name">User Last Name</label>
    <input id="name" class="input" type="text" maxlength="100" name="last_name" required value="<?php echo $user_lname; ?>" /><br><br>
    ...
    <input id="phone" class="input" type="password" name="password" required value="<?php echo $password; ?>" /><br><br>
   
    <label for="type">Permission</label>
        <select id="type" class="input" name="permissions" required>
            ...
            <option value="Super Admin" <?php if ($permission == "Super Admin") echo "selected"; ?>>Super Admin</option>
