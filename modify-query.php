...
// $sql = "UPDATE organization SET name='{$name}', type='{$type}', description='{$description}', address='{$address}', city='{$city}', state='{$state}', 
// email='{$email}', phone='{$phone}', logo_url='{$logo_url}', logo='{$logo}' WHERE id='{$_GET['id']}'";

$sql = "UPDATE organization SET name='{$name}', type='{$type}', description='{$description}', address='{$address}', city='{$city}', state='{$state}', 
email='{$email}', phone='{$phone}', logo='{$logo}' WHERE id='{$_GET['id']}'";
echo $sql;
